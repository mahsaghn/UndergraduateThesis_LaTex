...
\subsection{Features}
\label{sec:features}
In machine learning algorithms, feature engineering can be considered as the most important step because the desired model trains patterns only corresponding to predictors. Extracting sufficient predictors as compact as possible to having the best predicting accuracy and time efficient	, requires numerous experiments. In the following part of this section, extracted features are explained in detail.
