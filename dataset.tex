...
\item {\color{gray}\textbf{Unknown:}} There is not enough integrity between reliable news agencies sources.
\end{itemize}
...
\begin{table}
	...
	\begin{tabularx}{1\textwidth} { 
		...
		\hline \hline
		\ac{H2C} & 628  & 210  & 932 & 824  \\
		\hline
		\ac{A2C} & 189  & 374  & 797 & 1196  \\
		\hline
...
\begin{figure}%
	...
	\caption{Comparison between \ac{A2C} and \ac{H2C} labels, samples distribution in \cite{stance_persian} dataset.}%
	\label{fig:datacom}%
\end{figure}
